        ...
        <main>
                ...
                {listing.imageurls.map((url, index)=>(
                    <SwiperSlide key={index}>
                        <div style={{
                            ...
                            center no-repeat,
                            backgroundSize:cover`}} className="swiperSlideDiv"></div>
                    </SwiperSlide>
                ))}
            </Swiper>
             */}
            ...
            <div className="leafletContainer">
                    {listing.geolocation.latitude && (
                        <MapContainer style={{height: '100%', width:'100%'}} center={[listing.geolocation.latitude, listing.geolocation.longitude]} zoom={13} scrollWheelZoom={false} >
                            <TileLayer
                                attribution='&copy; <a href="http://osm.org/copyright">OpenStreetMap</a> contributors'
                                url='https://{s}.tile.openstreetmap.de/tiles/osmde/{z}/{x}/{y}.png'
                            />
                            <Marker position={[listing.geolocation.latitude, listing.geolocation.longitude]}>
